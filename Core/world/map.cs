namespace Core.world {
    ...
    public class Map {
        ...
        public void AddEmitter(Emitter emitter) { this.particleSystem.AddEmitter(emitter); }
        ...
        public void AddForceField(IForceField forceField) { this.particleSystem.AddForceField(forceField); }
        ...
        internal void Draw() {
            ...
            foreach(var tile in mapTiles) {                 // Draw tiles within the camera view
